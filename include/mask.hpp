...
constexpr BB Board::checkers() {
    ...
    return (PAWN_ATK[Us][ksq] & bb(Pawn)) | (KNIGHT_ATK[ksq] & bb(Knight)) |
           (BISHOP_ATK[ksq][occ] & bb(Bishop, Queen)) | (ROOK_ATK[ksq][occ] & bb(Rook, Queen));
}
...
template <Colour Us>
constexpr void Board::update_masks() {
