...
TEST(perft, bench_normal) { perft_bench(PerftMode::Normal, normal, 31); };
TEST(perft, bench_mp_normal) { perft_bench(PerftMode::MovePick, normal, 5); };
...
TEST(perft, bench_chess960) { perft_bench(PerftMode::Normal, chess960, 15); };
TEST(perft, bench_mp_chess960) { perft_bench(PerftMode::MovePick, chess960, 5); };
